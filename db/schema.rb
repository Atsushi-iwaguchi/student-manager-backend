...
ActiveRecord::Schema[8.1].define(version: 2026_07_21_011207) do
  ...
  create_table "interview_records", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.bigint "user_id", null: false
    t.index ["user_id"], name: "index_interview_records_on_user_id"
  end
  ...
  add_foreign_key "interview_records", "users"
end
